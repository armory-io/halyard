 ...
 * `disableDownloading`: Enable or disable jar downloading for all plugins
 * `edit`: Edit a plugin
 * `enable`: Enable or disable all plugins
 * `enableDownloading`: Enable or disable jar downloading for all plugins
...
Enable or disable jar downloading for all plugins
